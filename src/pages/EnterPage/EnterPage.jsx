    ...
    <React.Fragment>
      <div className='enterPage'>
        ...
        <div className='enterPage__aboutRegistration'>
          ...
          <p>
            Благодаря регистрации вы сможете записываться и отписываться от
            услуг, получать консультации по времени и услуге по телефону,
            получать рассылку новостоей от <span>Barber</span>
          </p>
        </div>
      </div>
      <MapComponent />
